 ...
 *
 * $Id: test_suite.cpp 6159 2011-05-18 15:24:52Z bless $
 * $HeadURL: https://svn.tm.kit.edu/nsis/qos-nslp/trunk/unittests/test_suite.cpp $
 */
#include <sstream>
...
void test_is_deserializable(const IE &ie, SourceLine line) {
	...
	Asserter::failIf(
		*ret != ie,
		Message("IE::deserialize(): objects differs from original after deserialization"),
		line);
