...
/// ----------------------------------------------------------
/// $Id: timer_module.cpp 4909 2010-01-22 11:50:50Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/src/timer_module.cpp $
// ===========================================================
//                      
...
bool TimerMsg::start_absolute(int32 sec, int32 msec, param_t p1, param_t p2, param_t p3) {
	return start(false,sec,msec,p1,p2,p3);
} // end start_absolute

/** Prepare message to start a relative timer. */
bool TimerMsg::start_relative(int32 sec, int32 msec, param_t p1, param_t p2, param_t p3) {
	return start(true,sec,msec,p1,p2,p3);
} // end start_relative

bool TimerMsg::start(bool rel, int32 sec, int32 msec, param_t p1, param_t p2, param_t p3) {
...
TimerMsg::param_t TimerMsg::get_param3() const { return param3; }
...
void TimerMsg::get_params(param_t& p1, param_t& p2, param_t& p3) const {
	p1 = param1;
	p2 = param2;
	p3 = param3;
} // end get_params
