...
/// ----------------------------------------------------------
/// $Id: messages.cpp 5724 2010-10-18 08:37:48Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/src/messages.cpp $
// ===========================================================
//                      
...
message::message(type_t t, qaddr_t s, id_t id) 
	: type(t), source(s), msg_id(id ? id : new_id()) {
} // end constructor

/// Copy constructor
message::message(const message& m)
	: type(m.type), source(m.source), msg_id(msg_id) {
} // end constructor
