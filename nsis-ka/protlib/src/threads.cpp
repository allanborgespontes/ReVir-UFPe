...
/// ----------------------------------------------------------
/// $Id: threads.cpp 6282 2011-06-17 13:31:57Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/src/threads.cpp $
// ===========================================================
//                      
...
/** This is the default sleep time (in s) and can be used as default value in
 * constructors.
 */
...
void Thread::stop_processing(bool do_lock) {
	...
	if (state==STATE_RUN) {
		state = STATE_STOP;
		// break any waiting condition at the queue
		signal_cond();
	}
