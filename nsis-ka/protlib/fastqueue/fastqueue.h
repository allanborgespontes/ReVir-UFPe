...
/// POSIX threads
/// ----------------------------------------------------------
/// $Id: fastqueue.h 6276 2011-06-17 07:18:20Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/fastqueue/fastqueue.h $
// ===========================================================
//                      
...
extern int signal_cond(queue_t *queuehead);
#endif
