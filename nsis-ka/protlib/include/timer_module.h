...
/// ----------------------------------------------------------
/// $Id: timer_module.h 6282 2011-06-17 13:31:57Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/include/timer_module.h $
// ===========================================================
//                      
...
public:
  ...
  bool start_absolute(int32 sec, int32 msec = 0, param_t p1 = NULL, param_t p2 = NULL, param_t p3 = NULL);
  /// start relative timer
  bool start_relative(int32 sec, int32 msec = 0, param_t p1 = NULL, param_t p2 = NULL, param_t p3 = NULL);
  /// start timer
  bool start(bool rel, int32 sec, int32 msec = 0, param_t p1 = NULL, param_t p2 = NULL, param_t p3 = NULL);
  ...
  /// get timer parameter #3
  param_t get_param3() const;
  /// get timer parameters
  void get_params(param_t& p1, param_t& p2) const;
  /// get timer parameters
  void get_params(param_t& p1, param_t& p2, param_t& p3) const;
...
class TimerModule : public Thread, public TimerCallback 
{
 ...
 private:
  ...
  private:
    typedef hashmap_t<message::id_t,timer_id_t> mid2tid_t;
    typedef mid2tid_t::const_iterator const_mid2tid_it_t;
    typedef hashmap_t<timer_id_t,message::id_t> tid2mid_t;
    typedef tid2mid_t::const_iterator const_tid2mid_it_t;
    typedef hashmap_t<timer_id_t,TimerMsg*> tid2msg_t;
