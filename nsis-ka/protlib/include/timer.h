...
/// ----------------------------------------------------------
/// $Id: timer.h 6282 2011-06-17 13:31:57Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/include/timer.h $
// ===========================================================
//                      
...
private:
	...
	typedef hashmap_t<timer_id_t,timer*> timer_hashmap_t;
	/// hashmap iterator
