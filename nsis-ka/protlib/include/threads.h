...
/// ----------------------------------------------------------
/// $Id: threads.h 6286 2011-06-18 04:36:33Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/include/threads.h $
// ===========================================================
//                      
...
class ThreadParam {
  public:
	ThreadParam();
	ThreadParam(uint32 sleeptime, const char* name,
...
void ThreadStarter<T, TParam>::wait_until_stopped() {
	...
	sleeptime.tv_sec= 0; sleeptime.tv_nsec= 100000000L; // 100ms
