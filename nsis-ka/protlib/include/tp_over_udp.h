...
/// Transport over UDP
/// ----------------------------------------------------------
/// $Id: tp_over_udp.h 6282 2011-06-17 13:31:57Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/include/tp_over_udp.h $
// ===========================================================
//                      
...
struct TPoverUDPParam : public ThreadParam 
{
  /// constructor
    TPoverUDPParam(
		 ...
		 port_t listen_port,
		 const char *threadname = "TPoverUDP",
...
public:
  ...
  virtual void send(NetMsg* msg, const address& addr, bool use_existing_connection, const address *local_addr= NULL);
...
private:
  ...
  void udpsend(NetMsg* msg, appladdress* addr, const hostaddress *local_addr);
