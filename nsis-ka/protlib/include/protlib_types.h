...
/// ----------------------------------------------------------
/// $Id: protlib_types.h 4107 2009-07-16 13:49:52Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/include/protlib_types.h $
// ===========================================================
//                      
...
class ProtLibException : public std::exception {
  ...
  protected:
	...
	ProtLibException(const std::string& msg) throw() : error_msg(msg) { }
...
ostream& operator<<(ostream& os, uint128 val);
