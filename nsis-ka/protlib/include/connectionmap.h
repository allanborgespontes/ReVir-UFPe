...
/// ----------------------------------------------------------
/// $Id: connectionmap.h 6282 2011-06-17 13:31:57Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/include/connectionmap.h $
// ===========================================================
//                      
...
private:
	...
	// only typedefs
	typedef hashmap_t<socketfd_t ,AssocData*> ass2data_t;
	typedef ass2data_t::const_iterator const_ass2data_it_t;
	typedef hashmap_t<appladdress,AssocData*> addr2data_t;
