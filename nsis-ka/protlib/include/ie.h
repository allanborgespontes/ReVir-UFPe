...
/// ----------------------------------------------------------
/// $Id: ie.h 6282 2011-06-17 13:31:57Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/include/ie.h $
// ===========================================================
//                      
...
class IEManager {
  ...
  private:
	typedef hashmap_t<IE_Key, IE *, hash_IE_Key> category_map_t;
