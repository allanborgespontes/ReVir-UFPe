...
/// ----------------------------------------------------------
/// $Id: tp.h 4210 2009-08-06 11:22:29Z bless $
/// $HeadURL: https://svn.tm.kit.edu/nsis/protlib/trunk/include/tp.h $
// ===========================================================
//                      
...
public:
	...
	virtual void send(NetMsg* msg, const address& addr, bool use_existing_connection= false, const address *local_addr = NULL) = 0;
...
protected:
  ...
  /**
   * function pointer type for call back function that is optionally called if 
   * a message was sent successfully. Could be used for flow control.
   */
  typedef void (*TPsentcallback_t)(bool success);
