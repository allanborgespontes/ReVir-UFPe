 ...
 *
 * $Id: nf.cpp 2300 2006-11-09 09:10:28Z stud-matfried $
 * $HeadURL: https://i72projekte.tm.uka.de/nsis/natfw-nslp/trunk/eval/nf.cpp $
 *
 */
...
int main(int argc, char *argv[]) {
	...
	n.run("nf2: processing incoming RESPONSE messages", num_sessions);
}
